...
namespace IHIS.CloudConnector.Contracts.Models.Orca
{
    public class ORCATransferOrdersHeaderInfo
    {
        ...
        public ORCATransferOrdersHeaderInfo(String facilityId, String sysDate, String hospName, String hospAddress, String hospZipcode, String facilityCode, String creatorText)
        {
