...
namespace IHIS.CloudConnector.Contracts.Models.Orca
{
    public class ORCATransferOrdersClaimInfo
    {
        ...
        public ORCATransferOrdersClaimInfo(String docUid03, String confirmDate03, String performTime, String bundleNumber, String hangmogCode, String doctorId, String gwa, String gwaName)
        {
