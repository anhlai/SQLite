...
namespace IHIS.CloudConnector.Contracts.Models.OcsEmr
{
    public class OCS2015U31EmrTagGetTemplateTagsInfo
    {
        ...
        public OCS2015U31EmrTagGetTemplateTagsInfo(String tagId, String tagCode, String tagName, String tagDisplayText, String description, String filterFlg, String tagParent, String sysId)
        {
            this._tagId = tagId;
