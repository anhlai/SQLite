...
{
    public class IFS0003U01GrdIFS0003Args : IContractArgs
    {
        ...
        public IFS0003U01GrdIFS0003Args() { }

        public IFS0003U01GrdIFS0003Args(String mapGubun, String mapGubunYmd)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.IFS0003U01GrdIFS0003Request();
        }
    }
}