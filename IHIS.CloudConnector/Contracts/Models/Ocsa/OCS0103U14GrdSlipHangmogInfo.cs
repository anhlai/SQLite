...
{
    public class OCS0103U14GrdSlipHangmogInfo
    {
        ...
        public OCS0103U14GrdSlipHangmogInfo() { }

        public OCS0103U14GrdSlipHangmogInfo(String slipCode, String position, String seq, String hangmogCode, String hangmogName, String specimenCode, String groupYn, String bulyongCheck, String wonnaeDrgYn, String trialFlg)
        {
