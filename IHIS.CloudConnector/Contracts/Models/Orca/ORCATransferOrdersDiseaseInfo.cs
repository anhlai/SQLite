...
namespace IHIS.CloudConnector.Contracts.Models.Orca
{
    public class ORCATransferOrdersDiseaseInfo
    {
        ...
        public ORCATransferOrdersDiseaseInfo(String diagnosisCode, String diagnosisSystem, String diagnosisStartDate, String diagnosisEndDate, String mmlTableId, String diagnosisCategory)
        {
