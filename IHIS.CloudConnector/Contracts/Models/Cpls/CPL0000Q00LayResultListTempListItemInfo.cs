...
{
	public class CPL0000Q00LayResultListTempListItemInfo
	{
		private String _sortA;
		private String _sortB;
		private String _sortC;
		private String _sortD;
		...
		private String _imageYn;
		private String _fkocs;
		private String _jundalGubunName;
		private String _commentsYn;

		public String SortA
		{
			get { return this._sortA; }
			set { this._sortA = value; }
		}

		public String SortB
		{
			get { return this._sortB; }
			set { this._sortB = value; }
		}

		public String SortC
		{
			get { return this._sortC; }
			set { this._sortC = value; }
		}

		public String SortD
		{
			get { return this._sortD; }
			set { this._sortD = value; }
		}
		...
		{
			get { return this._imageYn; }
			set { this._imageYn = value; }
		}
		...
		public String CommentsYn
		{
			get { return this._commentsYn; }
			set { this._commentsYn = value; }
		}

		public CPL0000Q00LayResultListTempListItemInfo() { }

		public CPL0000Q00LayResultListTempListItemInfo(String sortA, String sortB, String sortC, String sortD, String fkcpl2010, String hangmogCode, String specimenCode, String specimenName, String gumsaName, String emergency, String sourceGumsa, String cplResult, String resultDate, String resultTime, String resultForm, String confirmDate, String standardYn, String fromStandard, String toStandard, String standard, String panicYn, String deltaYn, String beforeResult, String danui, String danuiName, String bunho, String gwa, String doctor, String gubun, String hoDong, String hoCode, String jundalGubun, String slipCode, String specimenSer, String orderDate, String orderTime, String jubsuDate, String jubsuTime, String partJubsuDate, String partJubsuTime, String modifyYn, String modifyYn1, String pkcpl3020, String gwaName, String doctorName, String groupHangmog, String partJubsuja, String gumsaja, String suname, String age, String sex, String fixNote, String note, String jangbiCode, String srlCode, String imageYn, String fkocs, String jundalGubunName, String commentsYn)
		{
			this._sortA = sortA;
			this._sortB = sortB;
			this._sortC = sortC;
			...
			this._imageYn = imageYn;
			this._fkocs = fkocs;
			this._jundalGubunName = jundalGubunName;
			this._commentsYn = commentsYn;
		}
