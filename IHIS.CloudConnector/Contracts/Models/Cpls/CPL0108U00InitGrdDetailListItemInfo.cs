...
namespace IHIS.CloudConnector.Contracts.Models.Cpls
{
    public class CPL0108U00InitGrdDetailListItemInfo
    {
        ...
        public CPL0108U00InitGrdDetailListItemInfo() { }

        public CPL0108U00InitGrdDetailListItemInfo(String codeType, String code, String codeName, String codeNameRe, String systemGubun, String codeValue, String rowState)
        {
