...
namespace IHIS.CloudConnector.Contracts.Models.Nuro
{
    public class NuroInspectionOrderInfo
    {
        ...
        {
            get { return this._sortTime; }
            set { this._sortTime = value; }
        }

        public NuroInspectionOrderInfo() { }

        public NuroInspectionOrderInfo(String gwa, String gwaName, String bunho, String suname, String reserDate, String hangmogName, String reserTime, String moveName, String reserDay, String age, String birth, String suname2, String jundalPart, String reserMoveName, String hangmogCode, String jundalTable, String hopeDate, String seq, String sort, String sortTime)
        {
            this._gwa = gwa;
