...
namespace IHIS.CloudConnector.Contracts.Models.Outs
{
    public class OUT1001P03GrdBeforeJubsuInfo
    {
        ...
        public OUT1001P03GrdBeforeJubsuInfo(String ioGubun, String pkKey, String bunho, String suname, String naewonDate, String gwa, String gwaName, String doctor, String doctorName, String naewonTime, String selectYn, String comments, String bunhoType, String reserYn, String reserGubun)
        {
