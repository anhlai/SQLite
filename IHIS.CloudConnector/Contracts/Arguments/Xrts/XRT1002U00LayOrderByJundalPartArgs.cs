...
{
    public class XRT1002U00LayOrderByJundalPartArgs : IContractArgs
    {
        ...
        public XRT1002U00LayOrderByJundalPartArgs() { }

        public XRT1002U00LayOrderByJundalPartArgs(String orderDate, String inOutGubun, String fkout1001, String printDate, String printOnly, String jundalPart, String pkocs, String fkinp1001)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.XRT1002U00LayOrderByJundalPartRequest();
        }
    }
}