...
{
	public class OCS0131U00GrdOCS0132Info
	{
		...
		public OCS0131U00GrdOCS0132Info() { }

		public OCS0131U00GrdOCS0132Info(String code, String codeName, String sortKey, String groupKey, String ment, String valuePoint, String userId, String codeType, String dataRowState)
		{
			this._code = code;
