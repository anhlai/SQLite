...
{
	public class OCS0103U10SaveLayoutInfo
	{
		...
		public OCS0103U10SaveLayoutInfo(String userId, String orderGubun, String suryang, String dvTime, String dv, String ndayYn, String nalsu, String jusa, String bogyongCode, String emergency, String jaeryoJundalYn, String jundalTable, String jundalPart, String movePart, String muhyo, String portableYn, String antiCancerYn, String dcYn, String dcGubun, String bannabYn, String bannabConfirm, String powderYn, String hopeDate, String hopeTime, String dv1, String dv2, String dv3, String dv4, String dv5, String dv6, String dv7, String dv8, String mixGroup, String orderRemark, String nurseRemark, String bomOccurYn, String bomSourceKey, String nurseConfirmUser, String nurseConfirmDate, String nurseConfirmTime, String regularYn, String hubalChangeYn, String pharmacy, String jusaSpdGubun, String drgPackYn, String sortFkocskey, String wonyoiOrderYn, String specimenCode, String pkocskey, String inputId, String hangmogCode, String actBuseo, String bichiYn, String bogyongCodeSub, String bunho, String inputPart, String groupSer, String pay, String ocsFlag, String drgBunho, String inputTab, String orderDate, String inputGubun, String slipCode, String reserDate, String sgCode, String subSusul, String telYn, String seq, String reserTime, String actDoctor, String sgYmd, String inOutKey, String doctor, String actGwa, String ioGubun, String inputDoctor, String inputGwa, String sourceOrdKey, String rowState)
		{
			this._userId = userId;
