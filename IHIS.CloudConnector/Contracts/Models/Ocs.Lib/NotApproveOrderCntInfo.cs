...
{
	public class NotApproveOrderCntInfo
	{
		...
		public NotApproveOrderCntInfo() { }

		public NotApproveOrderCntInfo(String ioGubun, String userId, String insteadYn, String approveYn, String key)
		{
