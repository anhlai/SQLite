...
namespace IHIS.CloudConnector.Contracts.Models.OcsEmr
{
    public class OCS2015U09GetTemplateComboBoxInfo
    {
        ...
        public OCS2015U09GetTemplateComboBoxInfo(String emrTemplateId, String emrTemplateTypeId, String templateName, String templateContent, String description, String permissionType, String sysId, String updId, List<OCS2015U31EmrTagGetTemplateTagsInfo> tags)
        {
