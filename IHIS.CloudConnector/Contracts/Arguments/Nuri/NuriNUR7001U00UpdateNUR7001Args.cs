...
{
	public class NuriNUR7001U00UpdateNUR7001Args : IContractArgs
	{
		...
		public NuriNUR7001U00UpdateNUR7001Args() { }

		public NuriNUR7001U00UpdateNUR7001Args(String userId, String bunho, String measureDate, String seq, String height, String weight, String bpFrom, String bpTo, String bodyHeat, String pulse, String spo2, String measureTime, String breath)
		{
			this._userId = userId;
			this._bunho = bunho;
		...
		{
			return new NuriNUR7001U00UpdateNUR7001Request();
		}
	}
}