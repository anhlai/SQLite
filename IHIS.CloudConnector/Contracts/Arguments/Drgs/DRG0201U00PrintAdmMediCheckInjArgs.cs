...
{
	public class DRG0201U00PrintAdmMediCheckInjArgs : IContractArgs
	{
		...
		public DRG0201U00PrintAdmMediCheckInjArgs() { }

		public DRG0201U00PrintAdmMediCheckInjArgs(String jubsuDate, String drgBunho, String bunho, String dataDubun, String inOutGubun, String fk, String ioGubun, String sendYn, String gubun, String userId)
		{
		...
		{
			return new DRG0201U00PrintAdmMediCheckInjRequest();
		}
	}
}