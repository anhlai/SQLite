...
{
    public class PHY2001U04GetNewOrderFormINPArgs : IContractArgs
    {
        ...
        public PHY2001U04GetNewOrderFormINPArgs() { }

        public PHY2001U04GetNewOrderFormINPArgs(String orderDate, String timeHour, String timeMin, String timeSec)
        {
        ...
        {
            return new IHIS.CloudConnector.Messaging.PHY2001U04GetNewOrderFormINPRequest();
        }
    }
}