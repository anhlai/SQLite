...
namespace IHIS.CloudConnector.Contracts.Models.OcsEmr
{
    public class OCS2015U30EmrTagSaveLayoutInfo
    {
        ...
        public OCS2015U30EmrTagSaveLayoutInfo(String tagId, String tagName, String tagCode, String tagDisplayText, String description, String tagParent, String filterFlg, String rowState, String sysId)
        {
            this._tagId = tagId;
