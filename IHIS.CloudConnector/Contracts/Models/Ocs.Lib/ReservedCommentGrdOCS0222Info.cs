...
{
    public class ReservedCommentGrdOCS0222Info
    {
        ...
        public ReservedCommentGrdOCS0222Info() { }

        public ReservedCommentGrdOCS0222Info(String memb, String seq, String serial, String commentTitle, String commentText)
        {
            this._memb = memb;
            this._seq = seq;
            this._serial = serial;
