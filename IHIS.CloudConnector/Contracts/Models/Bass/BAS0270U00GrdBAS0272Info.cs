...
namespace IHIS.CloudConnector.Contracts.Models.Bass
{
    public class BAS0270U00GrdBAS0272Info
    {
        ...
        public BAS0270U00GrdBAS0272Info(String doctor, String doctorGwa, String doctorGwaName, String mainGwaYn, String startDate, String endDate, String sabun, String endYn, String dataRowState)
        {
            this._doctor = doctor;
