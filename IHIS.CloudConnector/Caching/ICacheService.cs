...
namespace IHIS.CloudConnector.Caching
{
    ...
    public interface ICacheService
    {
        ...
        /// <returns>The value associated with the specified key.</returns>
        TResult Get<TArg, TResult>(string key, TArg arg)
            where TResult : IContractResult
            where TArg : class, IContractArgs;
        ...
        /// <returns>The value associated with the specified key.</returns>
        TResult Get<TArg, TResult>(string key, TArg arg, Func<TResult> cacheIfEmpty)
            where TResult : IContractResult
            where TArg : class, IContractArgs;
        ...
        /// <param name="arg">The arg</param>
        /// <returns>The value associated with the specified key.</returns>
        TResult Get<TArg, TResult>(string key, Function<TArg, TResult> acquire, TArg arg)
            where TResult : IContractResult
            where TArg : class, IContractArgs;
        ...
        /// <param name="arg">The arg</param>
        /// <returns>The value associated with the specified key.</returns>
        TResult Get<TArg, TResult>(string key, TimeSpan cacheTime, Function<TArg, TResult> acquire, TArg arg)
            where TResult : IContractResult
            where TArg : class, IContractArgs;
