...
{
    public class END1001U02GrdPaStatusInfo
    {
        ...
        public END1001U02GrdPaStatusInfo(String bunho, String patStatus, String patStatusName, String patStatusCode, String patStatusCodeName, String ment, String seq, String indispensableYn, String contKey)
        {
            this._bunho = bunho;
