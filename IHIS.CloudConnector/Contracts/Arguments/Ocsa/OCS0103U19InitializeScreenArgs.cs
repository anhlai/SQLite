...
{
	public class OCS0103U19InitializeScreenArgs : IContractArgs
	{
		...
		public OCS0103U19InitializeScreenArgs() { }

		public OCS0103U19InitializeScreenArgs(LoadColumnCodeNameInfo codeInfo, GetUserOptionInfo userOptionInfo, ComboDataSourceInfo orderGubunInfo, ComboDataSourceInfo suryangInfo, ComboDataSourceInfo nalsuInfo, String orderMode, String userGubun, String doctor, String memb, String doctorId, String userId, String inputTab)
		{
		...
		{
			return new OCS0103U19InitializeScreenRequest();
		}
	}
}